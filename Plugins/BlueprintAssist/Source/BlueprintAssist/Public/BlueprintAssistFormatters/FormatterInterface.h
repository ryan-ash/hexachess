	...
	: public TSharedFromThis<FFormatterInterface>
{
	...
	virtual FEdGraphFormatterParameters& GetFormatterParameters() = 0;
	...
	virtual void PreFormatting() {}
	virtual void PostFormatting() {}
	...
	virtual bool ShouldIgnoreComment(TSharedPtr<FBACommentContainsNode> ContainsNode) = 0;
};
